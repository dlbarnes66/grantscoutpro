...
export default function ReviewerPanelPage({
  params,
}: {
  params: {
    id: string;
  ...
  useEffect(() => {
    async function load() {
      ...
      setReviewData({
        ...
        consensus:
          "Average score: 87. Strong impact, excellent compliance, and strong budget alignment. Evaluation plan needs refinement.",
  ...
  return (
    <div className="space-y-8">
      ...
      <CommentThreads
        threads={reviewData.comments}
        onReplyAction={() => {}}
      />

      <ConsensusSummary
        summary={reviewData.consensus}
      />

      <FundingLikelihood
        score={reviewData.likelihood}
      />
    </div>
  );
}