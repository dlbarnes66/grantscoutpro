  ...
  return (
    <div className="p-4 border rounded-md bg-white shadow-sm space-y-3">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mt-4">
        <a
          href={`/dashboard/${workspaceId}/grant/${grant.id}`}
        ...
        <a
          href={`/dashboard/${workspaceId}/grant/${grant.id}/sections`}
        ...
        <a
          href={`/dashboard/${workspaceId}/grant/${grant.id}/intelligence`}
        ...
        <a
          href={`/dashboard/${workspaceId}/grant/${grant.id}/submission`}
