        ...
        <div className="flex h-screen">
          <aside className="w-64 border-r border-slate-800 bg-slate-900/80 backdrop-blur">
            ...
            <nav className="mt-4 px-3 space-y-1 text-sm">
              <Link href="/dashboard" className="block rounded px-2 py-1 hover:bg-slate-800">
                Overview
              </Link>

              <Link href="/dashboard/activity" className="block rounded px-2 py-1 hover:bg-slate-800">
                Activity
              </Link>

              <Link href="/dashboard/grants" className="block rounded px-2 py-1 hover:bg-slate-800">
                Grants
              </Link>

              <Link href="/dashboard/ai" className="block rounded px-2 py-1 hover:bg-slate-800">
                AI Workspace
              </Link>

              <Link href="/dashboard/settings" className="block rounded px-2 py-1 hover:bg-slate-800">
                Settings
              </Link>
            </nav>
            ...
            <div className="mt-6 px-3">
              ...
              <nav className="space-y-1 text-sm">
                <Link href="/dashboard/help/manual" className="block rounded px-2 py-1 hover:bg-slate-800">
                  User Manual
                </Link>

                <Link href="/dashboard/help/ai" className="block rounded px-2 py-1 hover:bg-slate-800">
                  AI Help Chat
                </Link>
              </nav>
            </div>
